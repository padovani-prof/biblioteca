<section class="location-section">
    <div class="location-details">
        <h2><?= obter_parametro('index_local_tiendereco')?></h2>
        <!--p>R. Padre Calebe, 3725 - Mamoud Amed, Itacoatiara, Amazonas - Brasil<br>CEP: 69100-000</p-->
        <p><?= obter_parametro('index_local_endereco')?><br>
        <?= obter_parametro('index_local_cep')?></p>

        <h2><?= obter_parametro('index_local_titelefone')?></h2>
        <!--p>(92) 98488-2959</p-->
        <p><?= obter_parametro('index_local_telefone')?></p>

        <h2><?= obter_parametro('index_local_tiemail')?></h2>
        <!--p>biblioteca.com.br</p-->
        <p><?= obter_parametro('index_local_email')?></p>
    ...
    <div class="location-map">
        ...
        <?= obter_parametro('index_link_endereco')?>
